...
| [`rubber-duck-chat`](skills/ai-workflow/rubber-duck-chat) | Be the user's rubber duck — a warm, energetic chat that asks one sharp question at a time to help them think a bug, decision, or half-formed idea out loud, surfacing their own hidden assumptions instead of handing over answers. | — | `npx skills add webreactiva/skills --skill rubber-duck-chat` |
